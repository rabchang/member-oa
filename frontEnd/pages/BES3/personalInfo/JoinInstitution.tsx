  ...
  return (
    <Container component="main" maxWidth="md">
      ...
      >
        ...
        />
        <div></div>
        <div style={{ fontSize: "14px", color: "red", lineHeight: "1.2" }}>
          According to the relevant regulations of the BES3 Collaboration Group,
          a person becomes an author only one year after joining BES3
        </div>
